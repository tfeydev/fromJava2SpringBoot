...
-- ==========================================
-- Oracle XE E-Commerce Schema Setup (EC)
-- ==========================================
...
-- Ab hier mit Benutzer EC einloggen und folgendes ausführen:

-- Tabellen im Schema EC
-- (Ausführung nach Login mit Benutzer EC)
-- ==========================================
